...
function GalleryHero() {
  return (
    <section className="relative w-full min-h-[80vh] md:min-h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/gallery/gallery-hero-bg.png')" }}>
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-black/60 pointer-events-none" />
      
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white mb-8">
          Explore The Gallery
        </h2>
        <Link 
          to="/gallery" 
          className="px-8 py-3 rounded-full bg-gradient-to-r from-[#d946ef] to-[#f97316] text-white font-medium text-lg tracking-wide hover:opacity-90 hover:scale-105 transition-all shadow-lg pointer-events-auto inline-block"
        >
          Start Now
        </Link>
      </div>
